...
const Userlog = () => {
  const [ordenes, setOrdenes] = useState([
    {
      id: 1,
      descripcion: "Juego de cartas, juego de cartas...",
      fecha: "12 de febrero de 2022",
      total: "S/ 122.00",
      direccion: "Jiron Huascar 123, Jesus Maria, Lima, Peru",
      numeroOrden: "12345232",
    },
    {
      id: 2,
      descripcion: "Pokemon Red, Pokemon Blue, Ghost of Tsushima",
      fecha: "12 de febrero de 2022",
      total: "S/ 122.00",
      direccion: "Jiron Huascar 123, Jesus Maria, Lima, Peru",
      numeroOrden: "12345232",
    ...
    <div className="user-log-container">
      ...
      <section className="user-orders">
        ...
        <div className="pagination">
          {[...Array(Math.ceil(ordenes.length / ordenesPorPagina)).keys()].map(
            (numero) => (
              <button
                key={numero + 1}
